...
type FakeArchiverImpl struct {
	...
	CopyReleaseLogsStub        func([]string, string) error
	...
	GetLogFilesStub        func(string) ([]string, error)
	getLogFilesMutex       sync.RWMutex
	getLogFilesArgsForCall []struct {
		arg1 string
	}
	getLogFilesReturns struct {
		result1 []string
		result2 error
	}
	getLogFilesReturnsOnCall map[int]struct {
		result1 []string
		result2 error
	}
	MakeFilesPrivateStub        func(string, []string) error
...
func (fake *FakeArchiverImpl) CopyReleaseLogs(arg1 []string, arg2 string) error {
	var arg1Copy []string
	if arg1 != nil {
	...
	fake.recordInvocation("CopyReleaseLogs", []interface{}{arg1Copy, arg2})
...
func (fake *FakeArchiverImpl) CopyReleaseLogsCalls(stub func([]string, string) error) {
	fake.copyReleaseLogsMutex.Lock()
	defer fake.copyReleaseLogsMutex.Unlock()
	fake.CopyReleaseLogsStub = stub
}

func (fake *FakeArchiverImpl) CopyReleaseLogsArgsForCall(i int) ([]string, string) {
	fake.copyReleaseLogsMutex.RLock()
	defer fake.copyReleaseLogsMutex.RUnlock()
...
func (fake *FakeArchiverImpl) GetLogFiles(arg1 string) ([]string, error) {
	fake.getLogFilesMutex.Lock()
	ret, specificReturn := fake.getLogFilesReturnsOnCall[len(fake.getLogFilesArgsForCall)]
	fake.getLogFilesArgsForCall = append(fake.getLogFilesArgsForCall, struct {
		arg1 string
	}{arg1})
	stub := fake.GetLogFilesStub
	fakeReturns := fake.getLogFilesReturns
	fake.recordInvocation("GetLogFiles", []interface{}{arg1})
	fake.getLogFilesMutex.Unlock()
	if stub != nil {
		return stub(arg1)
	}
	if specificReturn {
...
func (fake *FakeArchiverImpl) GetLogFilesCallCount() int {
	fake.getLogFilesMutex.RLock()
	defer fake.getLogFilesMutex.RUnlock()
	return len(fake.getLogFilesArgsForCall)
}

func (fake *FakeArchiverImpl) GetLogFilesCalls(stub func(string) ([]string, error)) {
	fake.getLogFilesMutex.Lock()
	defer fake.getLogFilesMutex.Unlock()
	fake.GetLogFilesStub = stub
}

func (fake *FakeArchiverImpl) GetLogFilesArgsForCall(i int) string {
	fake.getLogFilesMutex.RLock()
	defer fake.getLogFilesMutex.RUnlock()
	argsForCall := fake.getLogFilesArgsForCall[i]
	return argsForCall.arg1
}

func (fake *FakeArchiverImpl) GetLogFilesReturns(result1 []string, result2 error) {
	fake.getLogFilesMutex.Lock()
	defer fake.getLogFilesMutex.Unlock()
	fake.GetLogFilesStub = nil
	fake.getLogFilesReturns = struct {
		result1 []string
		result2 error
	}{result1, result2}
}

func (fake *FakeArchiverImpl) GetLogFilesReturnsOnCall(i int, result1 []string, result2 error) {
	fake.getLogFilesMutex.Lock()
	defer fake.getLogFilesMutex.Unlock()
	fake.GetLogFilesStub = nil
	if fake.getLogFilesReturnsOnCall == nil {
		fake.getLogFilesReturnsOnCall = make(map[int]struct {
			result1 []string
			result2 error
		})
	}
	fake.getLogFilesReturnsOnCall[i] = struct {
		result1 []string
		result2 error
	}{result1, result2}
}

func (fake *FakeArchiverImpl) MakeFilesPrivate(arg1 string, arg2 []string) error {
	var arg2Copy []string
	if arg2 != nil {
	...
	fake.recordInvocation("MakeFilesPrivate", []interface{}{arg1, arg2Copy})
...
func (fake *FakeArchiverImpl) MakeFilesPrivateCalls(stub func(string, []string) error) {
	fake.makeFilesPrivateMutex.Lock()
	defer fake.makeFilesPrivateMutex.Unlock()
	fake.MakeFilesPrivateStub = stub
}

func (fake *FakeArchiverImpl) MakeFilesPrivateArgsForCall(i int) (string, []string) {
	fake.makeFilesPrivateMutex.RLock()
	defer fake.makeFilesPrivateMutex.RUnlock()
