...
//go:generate /usr/bin/env bash -c "cat ../../hack/boilerplate/boilerplate.generatego.txt releasefakes/fake_archiver_impl.go > releasefakes/_fake_archiver_impl.go && mv releasefakes/_fake_archiver_impl.go releasefakes/fake_archiver_impl.go"
