...
type FakeReleaseImpl struct {
	...
	releasePackageReturnsOnCall map[int]struct {
		result1 error
	}
...
func (fake *FakeReleaseImpl) CheckoutProjectCallCount() int {
...
func (fake *FakeReleaseImpl) CheckoutProjectReturnsOnCall(i int, result1 error) {
	fake.checkoutProjectMutex.Lock()
	defer fake.checkoutProjectMutex.Unlock()
	fake.CheckoutProjectStub = nil
...
func (fake *FakeReleaseImpl) CreateOBSConfigFile(arg1 string, arg2 string) error {
...
func (fake *FakeReleaseImpl) CreateOBSConfigFileCallCount() int {
...
func (fake *FakeReleaseImpl) CreateOBSConfigFileCalls(stub func(string, string) error) {
	fake.createOBSConfigFileMutex.Lock()
	defer fake.createOBSConfigFileMutex.Unlock()
	fake.CreateOBSConfigFileStub = stub
}

func (fake *FakeReleaseImpl) CreateOBSConfigFileArgsForCall(i int) (string, string) {
	fake.createOBSConfigFileMutex.RLock()
	defer fake.createOBSConfigFileMutex.RUnlock()
...
func (fake *FakeReleaseImpl) CreateOBSConfigFileReturns(result1 error) {
	fake.createOBSConfigFileMutex.Lock()
	defer fake.createOBSConfigFileMutex.Unlock()
...
func (fake *FakeReleaseImpl) CreateOBSConfigFileReturnsOnCall(i int, result1 error) {
	fake.createOBSConfigFileMutex.Lock()
	defer fake.createOBSConfigFileMutex.Unlock()
	fake.CreateOBSConfigFileStub = nil
...
func (fake *FakeReleaseImpl) MkdirAll(arg1 string) error {
...
func (fake *FakeReleaseImpl) MkdirAllCallCount() int {
	fake.mkdirAllMutex.RLock()
	defer fake.mkdirAllMutex.RUnlock()
	return len(fake.mkdirAllArgsForCall)
}

func (fake *FakeReleaseImpl) MkdirAllCalls(stub func(string) error) {
	fake.mkdirAllMutex.Lock()
	defer fake.mkdirAllMutex.Unlock()
	fake.MkdirAllStub = stub
}

func (fake *FakeReleaseImpl) MkdirAllArgsForCall(i int) string {
	fake.mkdirAllMutex.RLock()
	defer fake.mkdirAllMutex.RUnlock()
...
func (fake *FakeReleaseImpl) MkdirAllReturns(result1 error) {
	fake.mkdirAllMutex.Lock()
	defer fake.mkdirAllMutex.Unlock()
...
func (fake *FakeReleaseImpl) MkdirAllReturnsOnCall(i int, result1 error) {
	fake.mkdirAllMutex.Lock()
	defer fake.mkdirAllMutex.Unlock()
	fake.MkdirAllStub = nil
...
func (fake *FakeReleaseImpl) ReleasePackageCallCount() int {
...
func (fake *FakeReleaseImpl) ReleasePackageReturns(result1 error) {
	fake.releasePackageMutex.Lock()
	defer fake.releasePackageMutex.Unlock()
	fake.ReleasePackageStub = nil
	fake.releasePackageReturns = struct {
		result1 error
	}{result1}
}

func (fake *FakeReleaseImpl) ReleasePackageReturnsOnCall(i int, result1 error) {
	fake.releasePackageMutex.Lock()
	defer fake.releasePackageMutex.Unlock()
	fake.ReleasePackageStub = nil
	if fake.releasePackageReturnsOnCall == nil {
		fake.releasePackageReturnsOnCall = make(map[int]struct {
			result1 error
		})
	}
	fake.releasePackageReturnsOnCall[i] = struct {
		result1 error
	}{result1}
}
