...
type FakeImpl struct {
	...
	GetGCSBuildPathsStub        func(*cibuild.Options) ([]string, error)
	...
	ImagesExistStub        func(*cibuild.Options) (bool, error)
	...
	PushStub        func(*cibuild.Options) error
	...
	SetReleaseTypeStub        func(*cibuild.Options) string
...
func (fake *FakeImpl) ConfigureDockerAuth(arg1 *cibuild.Options) error {
...
func (fake *FakeImpl) ConfigureDockerAuthCalls(stub func(*cibuild.Options) error) {
	fake.configureDockerAuthMutex.Lock()
	defer fake.configureDockerAuthMutex.Unlock()
	fake.ConfigureDockerAuthStub = stub
}

func (fake *FakeImpl) ConfigureDockerAuthArgsForCall(i int) *cibuild.Options {
	fake.configureDockerAuthMutex.RLock()
	defer fake.configureDockerAuthMutex.RUnlock()
...
func (fake *FakeImpl) GetGCSBuildPaths(arg1 *cibuild.Options) ([]string, error) {
...
func (fake *FakeImpl) GetGCSBuildPathsCalls(stub func(*cibuild.Options) ([]string, error)) {
	fake.getGCSBuildPathsMutex.Lock()
	defer fake.getGCSBuildPathsMutex.Unlock()
	fake.GetGCSBuildPathsStub = stub
}

func (fake *FakeImpl) GetGCSBuildPathsArgsForCall(i int) *cibuild.Options {
	fake.getGCSBuildPathsMutex.RLock()
	defer fake.getGCSBuildPathsMutex.RUnlock()
...
func (fake *FakeImpl) ImagesExist(arg1 *cibuild.Options) (bool, error) {
...
func (fake *FakeImpl) ImagesExistCalls(stub func(*cibuild.Options) (bool, error)) {
	fake.imagesExistMutex.Lock()
	defer fake.imagesExistMutex.Unlock()
	fake.ImagesExistStub = stub
}

func (fake *FakeImpl) ImagesExistArgsForCall(i int) *cibuild.Options {
	fake.imagesExistMutex.RLock()
	defer fake.imagesExistMutex.RUnlock()
...
func (fake *FakeImpl) Push(arg1 *cibuild.Options) error {
	fake.pushMutex.Lock()
...
func (fake *FakeImpl) PushCalls(stub func(*cibuild.Options) error) {
	fake.pushMutex.Lock()
	defer fake.pushMutex.Unlock()
	fake.PushStub = stub
}

func (fake *FakeImpl) PushArgsForCall(i int) *cibuild.Options {
	fake.pushMutex.RLock()
	defer fake.pushMutex.RUnlock()
...
func (fake *FakeImpl) SetReleaseType(arg1 *cibuild.Options) string {
...
func (fake *FakeImpl) SetReleaseTypeCalls(stub func(*cibuild.Options) string) {
	fake.setReleaseTypeMutex.Lock()
	defer fake.setReleaseTypeMutex.Unlock()
	fake.SetReleaseTypeStub = stub
}

func (fake *FakeImpl) SetReleaseTypeArgsForCall(i int) *cibuild.Options {
	fake.setReleaseTypeMutex.RLock()
	defer fake.setReleaseTypeMutex.RUnlock()
