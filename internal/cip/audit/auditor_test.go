...
import (
	...
	"k8s.io/release/internal/cip/audit"
	reg "k8s.io/release/internal/cip/dockerregistry"
	"k8s.io/release/internal/cip/logclient"
	"k8s.io/release/internal/cip/remotemanifest"
	"k8s.io/release/internal/cip/report"
	"k8s.io/release/internal/cip/stream"
)
