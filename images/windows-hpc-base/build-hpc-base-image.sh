...
echo "" > "$BUILD_DIR/layer/Files/Windows/System32/config/SAM"
touch "$BUILD_DIR/layer/Files/Windows/System32/config/SECURITY"
echo "" > "$BUILD_DIR/layer/Files/Windows/System32/config/SECURITY"
touch "$BUILD_DIR/layer/Files/Windows/System32/config/SOFTWARE"
echo "" > "$BUILD_DIR/layer/Files/Windows/System32/config/SOFTWARE"
touch "$BUILD_DIR/layer/Files/Windows/System32/config/SYSTEM"
echo "" > "$BUILD_DIR/layer/Files/Windows/System32/config/SYSTEM"
