...
const patchReleaseExpectedContent = `# v1.25.3
...
- golang.org/x/sys: 8c9f86f → v0.13.0
...
- sigs.k8s.io/apiserver-network-proxy/konnectivity-client: v0.0.32 → v0.0.37
...
<html>
  ...
  <body>
    <h1>v1.25.3</h1>
<h2>Changelog since v1.25.2</h2>
<h2>Changes by Kind</h2>
<h3>API Change</h3>
<ul>
<li>Protobuf serialization of metav1.MicroTime timestamps (used in <code>Lease</code> and <code>Event</code> API objects) has been corrected to truncate to microsecond precision, to match the documented behavior and JSON/YAML serialization. Any existing persisted data is truncated to microsecond when read from etcd. (<a href="https://github.com/kubernetes/kubernetes/pull/111936">#111936</a>, <a href="https://github.com/haoruan">@haoruan</a>) [SIG API Machinery]</li>
</ul>
<h3>Feature</h3>
<ul>
<li>Kubernetes is now built with Go 1.19.2 (<a href="https://github.com/kubernetes/kubernetes/pull/112902">#112902</a>, <a href="https://github.com/xmudrii">@xmudrii</a>) [SIG Release and Testing]</li>
<li>Kubernetes is now built with Go 1.19.3 (<a href="https://github.com/kubernetes/kubernetes/pull/113592">#113592</a>, <a href="https://github.com/xmudrii">@xmudrii</a>) [SIG Release and Testing]</li>
</ul>
<h3>Bug or Regression</h3>
<ul>
<li>Bump golang.org/x/net to v0.1.1-0.20221027164007-c63010009c80 (<a href="https://github.com/kubernetes/kubernetes/pull/112693">#112693</a>, <a href="https://github.com/aimuz">@aimuz</a>) [SIG API Machinery, Architecture, Auth, CLI, Cloud Provider, Cluster Lifecycle, Instrumentation, Node, Security and Storage]</li>
<li>Consider only plugin directory and not entire kubelet root when cleaning up mounts (<a href="https://github.com/kubernetes/kubernetes/pull/112887">#112887</a>, <a href="https://github.com/mattcary">@mattcary</a>) [SIG Storage]</li>
<li>Etcd: Update to v3.5.5 (<a href="https://github.com/kubernetes/kubernetes/pull/112489">#112489</a>, <a href="https://github.com/dims">@dims</a>) [SIG API Machinery, Cloud Provider, Cluster Lifecycle and Testing]</li>
<li>Fix list cost estimation in Priority and Fairness for list requests with metadata.name specified. (<a href="https://github.com/kubernetes/kubernetes/pull/112557">#112557</a>, <a href="https://github.com/marseel">@marseel</a>) [SIG API Machinery]</li>
<li>Fixed a bug where a change in the <code>appProtocol</code> for a Service did not trigger a load balancer update. (<a href="https://github.com/kubernetes/kubernetes/pull/113031">#113031</a>, <a href="https://github.com/MartinForReal">@MartinForReal</a>) [SIG Cloud Provider and Network]</li>
<li>Fixes an issue in winkernel proxier that causes proxy rules to leak anytime service backends are modified. (<a href="https://github.com/kubernetes/kubernetes/pull/112840">#112840</a>, <a href="https://github.com/daschott">@daschott</a>) [SIG Network and Windows]</li>
<li>For raw block CSI volumes on Kubernetes, kubelet was incorrectly calling CSI NodeStageVolume for every single &quot;map&quot; (i.e. raw block &quot;mount&quot;) operation for a volume already attached to the node. This PR ensures it is only called once per volume per node. (<a href="https://github.com/kubernetes/kubernetes/pull/112403">#112403</a>, <a href="https://github.com/akankshakumari393">@akankshakumari393</a>) [SIG Storage]</li>
<li>Kube-apiserver: DELETECOLLECTION API requests are now recorded in metrics with the correct verb. (<a href="https://github.com/kubernetes/kubernetes/pull/113133">#113133</a>, <a href="https://github.com/sxllwx">@sxllwx</a>) [SIG API Machinery]</li>
<li>Kube-apiserver: bugfix DeleteCollection API fails if request body is non-empty (<a href="https://github.com/kubernetes/kubernetes/pull/113286">#113286</a>, <a href="https://github.com/sxllwx">@sxllwx</a>) [SIG API Machinery]</li>
<li>Kube-proxy, will restart in case it detects that the Node assigned pod.Spec.PodCIDRs have changed (<a href="https://github.com/kubernetes/kubernetes/pull/113247">#113247</a>, <a href="https://github.com/code-elinka">@code-elinka</a>) [SIG Cloud Provider, Network and Storage]</li>
<li>Kube-scheduler: add taints filtering logic consistent with TaintToleration plugin for PodTopologySpread plugin (<a href="https://github.com/kubernetes/kubernetes/pull/112357">#112357</a>, <a href="https://github.com/SataQiu">@SataQiu</a>) [SIG Scheduling and Testing]</li>
<li>Kubelet: fix GetAllocatableCPUs method in cpumanager (<a href="https://github.com/kubernetes/kubernetes/pull/113420">#113420</a>, <a href="https://github.com/Garrybest">@Garrybest</a>) [SIG Node]</li>
<li>Pod logs using --timestamps are not broken up with timestamps anymore. (<a href="https://github.com/kubernetes/kubernetes/pull/113515">#113515</a>, <a href="https://github.com/rphillips">@rphillips</a>) [SIG Node]</li>
<li>This reverts <a href="https://github.com/kubernetes/kubernetes/pull/109706">https://github.com/kubernetes/kubernetes/pull/109706</a> and <a href="https://github.com/kubernetes/kubernetes/pull/111691">https://github.com/kubernetes/kubernetes/pull/111691</a> which caused <a href="https://github.com/kubernetes/kubernetes/issues/112793">https://github.com/kubernetes/kubernetes/issues/112793</a>. I.e: the service controller to incorrectly sync load balancers for ExternalTrafficPolicy=Local under certain conditions (<a href="https://github.com/kubernetes/kubernetes/pull/112807">#112807</a>, <a href="https://github.com/alexanderConstantinescu">@alexanderConstantinescu</a>) [SIG Cloud Provider and Network]</li>
</ul>
<h2>Dependencies</h2>
<h3>Added</h3>
<ul>
...
<li>golang.org/x/crypto: 3147a52 → v0.14.0</li>
<li>golang.org/x/lint: 6edffad → 1621716</li>
<li>golang.org/x/mod: 86c51ed → v0.8.0</li>
<li>golang.org/x/net: a158d28 → v0.17.0</li>
<li>golang.org/x/sync: 886fb93 → v0.1.0</li>
<li>golang.org/x/sys: 8c9f86f → v0.13.0</li>
<li>golang.org/x/term: 03fcf44 → v0.13.0</li>
<li>golang.org/x/text: v0.3.7 → v0.13.0</li>
<li>golang.org/x/tools: v0.1.12 → v0.6.0</li>
<li>k8s.io/system-validators: v1.7.0 → v1.8.0</li>
<li>sigs.k8s.io/apiserver-network-proxy/konnectivity-client: v0.0.32 → v0.0.37</li>
</ul>
<h3>Removed</h3>
